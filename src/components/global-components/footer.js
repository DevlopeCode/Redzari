              ...
              <div className="col-lg-2 col-md-6">
                <div className="widget widget_nav_menu">
                  ...
                  <ul>
                    ...
                    <li><a href="https://www.youtube.com/watch?v=R3bC0ThQ2pM" target="_blank" ><i className="icon-instagram" /> Instagram</a></li>
                    <li><a href="https://www.youtube.com/watch?v=R3bC0ThQ2pM" target="_blank" ><i className="icon-youtube" /> Youtube</a></li>
                  </ul>
                </div>
              </div>
            </div>
