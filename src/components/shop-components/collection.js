		          ...
		          <div className="tab-pane fade in show active" id="one">
		            <div className="row">
		                ...
		                <div className="product-style-03 margin-top-40">
		                  <div className="thumb">
		                    ...
		                    <ul className="cart-action">
		                      <li><a className="add-to-cart" data-img="assets/redzari/redzari/DSC_0246.JPG" data-name="Faxon Canvas Low-Top Sneaker" data-price="450" href="#"><i className="icon-add-to-cat" /> </a></li>
		              ...
		              <div className="col-xl-4 col-lg-6 col-md-6 col-sm-6 col-12">
		                <div className="product-style-03 margin-top-40">
		                  <div className="thumb">
		                    ...
		                    <ul className="cart-action">
		                      <li><a className="add-to-cart" data-img="assets/redzari/redzari/DSC_0208.JPG" data-name="Viscose-Cashmere Scarf" data-price="450" href="#"><i className="icon-add-to-cat" /></a></li>
		                      <li><a href="#"><i className="icon-heart" /></a></li>
		                    </ul>
		                  </div>
		                  <div className="content text-center">
		              ...
		              <div className="col-xl-4 col-lg-6 col-md-6 col-sm-6 col-12">
		                <div className="product-style-03 margin-top-40">
		                  <div className="thumb">
		                    <img src={publicUrl+"assets/redzari/redzari/DSC_0220.JPG" }alt="" />
		                    <span className="new">New</span>
		                    <ul className="cart-action">
		                      <li><a className="add-to-cart" data-img="assets/redzari/redzari/DSC_0220.JPG" data-name="Round neck sweater" data-price="450" href="#"><i className="icon-add-to-cat" /></a></li>
		                      <li><a href="#"><i className="icon-heart" /></a></li>
		                    </ul>
		                  </div>
		                  <div className="content text-center">
		              ...
		              <div className="col-xl-4 col-lg-6 col-md-6 col-sm-6 col-12">
		                <div className="product-style-03 margin-top-40">
		                  <div className="thumb">
		                    ...
		                    <ul className="cart-action">
		                      <li><a className="add-to-cart" data-img="assets/redzari/redzari/DSC_0279.JPG" data-name="Viscose-Cashmere Scarf" data-price="450" href="#"><i className="icon-add-to-cat" /></a></li>
		                      <li><a href="#"><i className="icon-heart" /></a></li>
		                    </ul>
		                  </div>
		                  <div className="content text-center">
		              ...
		              <div className="col-xl-4 col-lg-6 col-md-6 col-sm-6 col-12">
		                <div className="product-style-03 margin-top-40">
		                  <div className="thumb">
		                    ...
		                    <ul className="cart-action">
		                      <li><a className="add-to-cart" data-img="assets/redzari/redzari/DSC_0191.JPG" data-name="Faxon Canvas Low-Top Sneaker" data-price="450" href="#"><i className="icon-add-to-cat" /> </a></li>
		                      <li><a href="#"><i className="icon-heart" /></a></li>
		                    </ul>
		                  </div>
		                  <div className="content text-center">
		              ...
		              <div className="col-xl-4 col-lg-6 col-md-6 col-sm-6 col-12">
		                <div className="product-style-03 margin-top-40">
		                  <div className="thumb">
		                    ...
		                    <ul className="cart-action">
		                      <li><a className="add-to-cart" data-img="assets/redzari/redzari/DSC_0268.JPG" data-name="Round neck sweater" data-price="450" href="#"><i className="icon-add-to-cat" /> </a></li>
		                      <li><a href="#"><i className="icon-heart" /></a></li>
		                    </ul>
		                    <span className="sale">Sale! 13%</span>
		              ...
		              <div className="col-xl-4 col-lg-6 col-md-6 col-sm-6 col-12">
		                <div className="product-style-03 margin-top-40">
		                  <div className="thumb">
		                    ...
		                    <ul className="cart-action">
		                      <li><a className="add-to-cart" data-img="assets/redzari/redzari/DSC_0286.JPG" data-name="Faxon Canvas Low-Top Sneaker" data-price="450" href="#"><i className="icon-add-to-cat" /> </a></li>
		                      <li><a href="#"><i className="icon-heart" /></a></li>
		                    </ul>
		                  </div>
		                  <div className="content text-center">
		              ...
		              <div className="col-xl-4 col-lg-6 col-md-6 col-sm-6 col-12">
		                <div className="product-style-03 margin-top-40">
		                  <div className="thumb">
		                    ...
		                    <span className="new margin-top-35">New</span>
		                    <ul className="cart-action">
		                      <li><a className="add-to-cart" data-img="assets/redzari/redzari/DSC_0298.JPG" data-name="Viscose-Cashmere Scarf" data-price="450" href="#"><i className="icon-add-to-cat" /></a></li>
		                      <li><a href="#"><i className="icon-heart" /></a></li>
		                    </ul>
		                  </div>
		                  <div className="content text-center">
		              ...
		              <div className="col-xl-4 col-lg-6 col-md-6 col-sm-6 col-12">
		                <div className="product-style-03 margin-top-40">
		                  <div className="thumb">
		                    ...
		                    <span className="new">New</span>
		                    <ul className="cart-action">
		                      <li><a className="add-to-cart" data-img="assets/redzari/redzari/DSC_0260.JPG" data-name="Round neck sweate" data-price="450" href="#"><i className="icon-add-to-cat" /> </a></li>
		                      <li><a href="#"><i className="icon-heart" /></a></li>
		                    </ul>
		                  </div>
		                  <div className="content text-center">
		              ...
		              <div className="col-xl-4 col-lg-6 col-md-6 col-sm-6 col-12">
		                <div className="product-style-03 margin-top-40">
		                  <div className="thumb">
		                    ...
		                    <span className="out">Sold out</span>
		                    <ul className="cart-action">
		                      <li><a className="add-to-cart" data-img="assets/redzari/redzari/DSC_0272.JPG" data-name="Faxon Canvas Low-Top Sneaker" data-price="450" href="#"><i className="icon-add-to-cat" /> </a></li>
		                      <li><a href="#"><i className="icon-heart" /></a></li>
		                    </ul>
		                  </div>
		                  <div className="content text-center">
		              ...
		              <div className="col-xl-4 col-lg-6 col-md-6 col-sm-6 col-12">
		                <div className="product-style-03 margin-top-40">
		                  <div className="thumb">
		                    ...
		                    <ul className="cart-action">
		                      <li><a className="add-to-cart" data-img="assets/redzari/redzari/DSC_0255.JPG" data-name="Viscose-Cashmere Scarf" data-price="450" href="#"><i className="icon-add-to-cat" /> </a></li>
		                      <li><a href="#"><i className="icon-heart" /></a></li>
		                    </ul>
		                  </div>
		                  <div className="content text-center">
		              ...
		              <div className="col-xl-4 col-lg-6 col-md-6 col-sm-6 col-12">
		                <div className="product-style-03 margin-top-40">
		                  <div className="thumb">
		                    ...
		                    <ul className="cart-action">
		                      <li><a className="add-to-cart" data-img="assets/redzari/redzari/DSC_0244.JPG" data-name="Viscose-Cashmere Scarf" data-price="450" href="#"><i className="icon-add-to-cat" /></a></li>
		                      <li><a href="#"><i className="icon-heart" /></a></li>
		                    </ul>
		                    <span className="sale">Sale! 13%</span>
		                  </div>
		              ...
		              <div className="col-xl-4 col-lg-6 col-md-6 col-sm-6 col-12">
		                <div className="product-style-03 margin-top-40">
		                  <div className="thumb">
		                    <img src={publicUrl+"assets/redzari/redzari/DSC_0241.JPG"} alt="" />
		                    <span className="out">Sold out</span>
		                    <ul className="cart-action">
		                      <li><a className="add-to-cart" data-img="assets/redzari/redzari/DSC_0241.JPG" data-name="Faxon Canvas Low-Top Sneaker" data-price="450" href="#"><i className="icon-add-to-cat" /> </a></li>
		                      <li><a href="#"><i className="icon-heart" /></a></li>
		                    </ul>
		                  </div>
		                  <div className="content text-center">
		              ...
		              <div className="col-xl-4 col-lg-6 col-md-6 col-sm-6 col-12">
		                <div className="product-style-03 margin-top-40">
		                  <div className="thumb">
		                    ...
		                    <ul className="cart-action">
		                      <li><a className="add-to-cart" data-img="assets/redzari/redzari/DSC_0232.JPG" data-name="Round neck sweater" data-price="450" href="#"><i className="icon-add-to-cat" /> </a></li>
		                      <li><a href="#"><i className="icon-heart" /></a></li>
		                    </ul>
		                  </div>
		                  <div className="content text-center">
		              ...
		              <div className="col-xl-4 col-lg-6 col-md-6 col-sm-6 col-12">
		                <div className="product-style-03 margin-top-40">
		                  <div className="thumb">
		                    <img src={publicUrl+"assets/redzari/redzari/DSC_0168.JPG"} alt="" />
		                    <span className="out">Sold out</span>
		                    <ul className="cart-action">
		                      <li><a className="add-to-cart" data-img="assets/redzari/redzari/DSC_0168.JPG" data-name="Viscose-Cashmere Scarf" data-price="450" href="#"><i className="icon-add-to-cat" /></a></li>
		                      <li><a href="#"><i className="icon-heart" /></a></li>
		                    </ul>
		                  </div>
		                  <div className="content text-center">
		              ...
		              <div className="col-xl-4 col-lg-6 col-md-6 col-sm-6 col-12">
		                <div className="product-style-03 margin-top-40">
		                  <div className="thumb">
		                    <img src={publicUrl+"assets/redzari/redzari/DSC_0207.JPG"} alt="" />
		                    <ul className="cart-action">
		                      <li><a className="add-to-cart" data-img="assets/redzari/redzari/DSC_0207.JPG" data-name="Faxon Canvas Low-Top Sneake" data-price="450" href="#"><i className="icon-add-to-cat" /> </a></li>
		                      <li><a href="#"><i className="icon-heart" /></a></li>
		                    </ul>
		                  </div>
		                  <div className="content text-center">
